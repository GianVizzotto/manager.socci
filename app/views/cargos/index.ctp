...
<div class="container_4 no-space">
	<div id="page-heading" class="clearfix">
		...
		<div class="grid_2 align_right">
			<div class="page-wrap">
				<a href="/cargos/add" class="button red medium">Adicionar Cargo</a>
			</div>
		</div>
	</div>
</div>
...
<div class="container_4">
	...
	<div class="grid_4">
		<div class="panel">
			<h2 class="cap">Lista de Cargos</h2>
			<div class="content">			
				...
				<table id="tablesorter-sample" class="tablesorter styled"> 
					<thead> 
						<tr> 
							...
							<th>Nome do Cargo</th> 
							<th>Descri&ccedil;&atilde;o do Cargo</th> 
					...
					<tbody>
						...
						<tr> 
							...
							<td class="center"><a class="icon-button edit" href="/cargos/edit/<?php echo $cargo['Cargo']['id'] ?>">Editar</a><a class="icon-button delete" href="/cargos/remove/<?php echo $cargo['Cargo']['id'] ?>"">Remover</a></td> 
						</tr>
